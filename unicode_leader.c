...
void unicode_leader_on_leader_end(void) {
  switch (pack_leader_sequence()) {
    ...
    case SEQ3(         KC_E, KC_T, KC_A):    register_unicode(0x03B7);  break; // eta   -> η
    ...
    case SEQ4(KC_A, KC_S, KC_I, KC_G):       register_unicode(0x03C2);  break; // asig  -> ς
    case SEQ3(         KC_T, KC_A, KC_U):    register_unicode(0x03C4);  break; // tau   -> τ

...
KEY_OVERRIDE_SHIFT_OR_COMBO(o_none_5_none, o_none_5_shift, KC_5, KC_EXLM);
...
KEY_OVERRIDE_SHIFT(o_comm_dlr,  KC_COMM, KC_DLR);
...
KEY_OVERRIDE_SHIFT(o_hash_astr, KC_HASH, KC_ASTR);

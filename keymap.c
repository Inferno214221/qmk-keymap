...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_DEF] = LAYOUT_moonlander(
    ...
    //          KC_LCBR,    KC_RCBR,    KC_LABK,    KC_RABK,    XXXXXXXX,                                                   XXXXXXXX,   KC_LBRC,    KC_RBRC,    KC_LPRN,    KC_RPRN,
    KC_ESC,     PR_BRACE,   KC_2,       PR_ANGLE,   KC_4,       MA_ARROW,   KC_CALC,                            KC_PSCR,    MA_SLICE,   PR_BRACK,   KC_8,       PR_PAREN,   KC_0,       OSL(L_FUN),
    KC_TAB,     KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       KC_HOME,                            KC_END,     KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_HASH,
    KC_LGUI,    KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       TH_ALTU,                            TG(L_NUM),  KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    PR_QUOTE,
    PR_BTICK,   KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,                                                       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    PR_AMPIP,
    KC_PERC,    KC_MINS,    KC_EQL,     KC_UP,      KC_DOWN,                XXXXXXX,                            LCTL(KC_V),             KC_LEFT,    KC_RGHT,    KC_EXLM,    KC_QUES,    KC_DEL,
  ...
  [L_FUN] = LAYOUT_moonlander(
    ...
    XXXXXXX,    KC_MPRV,    KC_MSTP,    KC_MNXT,    XXXXXXX,    XXXXXXX,    _______,                            TO(L_GAM),  XXXXXXX,    XXXXXXX,    KM_PREV,    KM_STOP,    KM_NEXT,    XXXXXXX,
    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,                                                    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,
    AU_TOGG,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,                XXXXXXX,                            XXXXXXX,                XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    TO(L_TET),

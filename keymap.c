...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_DEF] = LAYOUT_moonlander(
    ...
    QK_LEAD,    KC_MINS,    KC_EQL,     KC_UP,      KC_DOWN,                XXXXXXX,                            LCTL(KC_V),             KC_LEFT,    KC_RGHT,    KC_QUES,    KC_ASTR,    KC_DEL,
                                                                KC_LSFT,    KC_BSPC,    KC_LCTL,    TD(T_COPY), KC_SPC,     KC_ENT
  ),
  [L_FUN] = LAYOUT_moonlander(
    QK_BOOT,    KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,                              KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12,     ALT_NO,

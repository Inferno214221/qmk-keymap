...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_DEF] = LAYOUT_moonlander(
    ...
    //          KC_LCBR,    KC_RCBR,    KC_LABK,    KC_RABK,    XXXXXXXX,                                                   KC_PERC,    KC_LBRC,    KC_RBRC,    KC_LPRN,    KC_RPRN,
    KC_ESC,     KC_1,       KC_2,       KC_3,       KC_4,       MA_ARROW,   KC_CALC,                            KC_PSCR,    KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       OSL(L_FUN),
    KC_TAB,     KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       KC_HOME,                            KC_END,     KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_HASH,
    KC_LGUI,    KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       INF_IND,                            TG(L_NUM),  KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_QUOT,
  ...
  [L_NUM] = LAYOUT_moonlander(
    ...
    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    _______,                            _______,    XXXXXXX,    XXXXXXX,    KC_P4,      KC_P5,      KC_P6,      KC_PSLS,
  ...
  [L_GAM] = LAYOUT_moonlander(
    ...
    KC_GRV,     _______,    _______,    _______,    _______,    _______,    _______,                            TO(L_DEF),  _______,    _______,    _______,    _______,    KC_SCLN,    KC_QUOT,

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_DEF] = LAYOUT_moonlander(
    ...
    KC_LGUI,    KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       XXXXXXX,                            TG(L_NUM),  KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    PR_QUOTE,
    PR_BTICK,   KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,                                                       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    PR_AMPIP,
    KC_PERC,    KC_MINS,    KC_EQL,     KC_UP,      KC_DOWN,                TH_ALTU,                            LCTL(KC_V),             KC_LEFT,    KC_RGHT,    KC_QUES,    KC_EXLM,    KC_DEL,

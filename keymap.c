...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_DEF] = LAYOUT_moonlander(
    ...
    KC_DLR,     KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       XXXXXXX,                            LCTL(KC_V), KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_ASTR,
    KC_CIRC,    KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       OSL(L_NUM),                         TD(T_COPY), KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    PR_QUOTE,
    PR_BTICK,   KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,                                                       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    PR_AMPIP,
    KC_TAB,     KC_MINS,    KC_EQL,     KC_UP,      KC_DOWN,                TH_ALTU,                            KC_LGUI,                KC_LEFT,    KC_RGHT,    KC_HOME,    KC_END,     KC_DEL,
                                                                KC_LSFT,    KC_BSPC,    KC_LCTL,    XXXXXXX,    KC_SPC,     KC_ENT
  ),
  [L_FUN] = LAYOUT_moonlander(
    ...
    XXXXXXX,    KC_MPRV,    KC_MSTP,    KC_MNXT,    XXXXXXX,    XXXXXXX,    TO(L_GAM),                          XXXXXXX,    XXXXXXX,    XXXXXXX,    KM_PREV,    KM_STOP,    KM_NEXT,    XXXXXXX,
  ...
  [L_NUM] = LAYOUT_moonlander(
    ...
    _______,    XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_RCBR,    KC_RABK,    XXXXXXX,                            _______,    KC_RBRC,    KC_RPRN,    KC_P7,      KC_P8,      KC_P9,      KC_PAST,
    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    PR_BRACE,   PR_ANGLE,   _______,                            _______,    PR_BRACK,   PR_PAREN,    KC_P4,      KC_P5,      KC_P6,      KC_PSLS,
    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,                                                    XXXXXXX,    XXXXXXX,    KC_P1,      KC_P2,      KC_P3,      KC_CIRC,
    XXXXXXX,    KC_PMNS,    KC_PPLS,    _______,    _______,                XXXXXXX,                            XXXXXXX,                _______,    _______,    KC_P0,      KC_PDOT,    KC_PENT,

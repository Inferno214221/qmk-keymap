...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_DEF] = LAYOUT_moonlander(
    ...
    KC_ESC,     KC_1,       KC_2,       KC_3,       KC_4,       MA_ARROW,   KC_CALC,                            KC_PSCR,    MA_SLICE,   KC_7,       KC_8,       KC_9,       KC_0,       OSL(L_FUN),
    KC_TAB,     KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       KC_HOME,                            KC_END,     KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_HASH,
    XXXXXXX,    KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       KC_LGUI,                            TG(L_NUM),  KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_QUOT,

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_FUN] = LAYOUT_moonlander(
    ...
    XXXXXXX,    KC_MPRV,    KC_MSTP,    KC_MNXT,    XXXXXXX,    XXXXXXX,    INF_IND,                            TO(L_GAM),  XXXXXXX,    XXXXXXX,    KM_PREV,    KM_STOP,    KM_NEXT,    XXXXXXX,
  ...
  [L_NUM] = LAYOUT_moonlander(
    ...
    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    INF_IND,                            _______,    XXXXXXX,    XXXXXXX,    KC_P4,      KC_P5,      KC_P6,      KC_PSLS,
  ...
  [L_GAM] = LAYOUT_moonlander(
    ...
    KC_GRV,     _______,    _______,    _______,    _______,    _______,    INF_IND,                            TO(L_DEF),  _______,    _______,    _______,    _______,    KC_SCLN,    KC_QUOT,
